...
import 'package:all_in_project/features/common/app_colors.dart';
import 'package:all_in_project/features/data/home_data.dart';
import 'package:all_in_project/features/presentation/home/home_screen_view_model.dart';
import 'package:all_in_project/features/presentation/routes/home_routes.dart';
    ...
    return Container(
      ...
      child: const Text.rich(
        TextSpan(
          style: TextStyle(color: Colors.white),
          children: [
            TextSpan(text: "ทักษะและความสามารถ\n"),
            TextSpan(
              text: "Resume/CV",
              style: TextStyle(
                fontSize: 24,
    ...
    return Column(
      children: [
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 20),
          child: SectionTitle(
            title: "แอปพลิเคชันที่เคย/ร่วมพัฒนา",
            press: () => Navigator.of(context).pushNamed(AppRoutes.applicationDev),
          ),
        ),
        SingleChildScrollView(
          scrollDirection: Axis.horizontal,
